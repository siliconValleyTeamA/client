...
import styles from './USDetailPage.module.scss';
...
function USDetailPage() {
  ...
  const imageLinkList = project.image !== undefined ? project.image.split('&') : [];
