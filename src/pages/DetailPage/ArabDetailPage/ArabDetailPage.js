...
import styles from './ArabDetailPage.module.scss';
    ...
    <div className={cx('detail')}>     
      ...
      <div className={cx('leftside')}>        
        <div className={cx('product-details-info')}>
          ...
          <bdo dir="rtl" style={{textalign: "right"}}>{project.company}</bdo>
          </div>          
          <div className={cx('product-details-info-name')}><bdo dir="rtl">{project.title}</bdo></div>
          <Hit />
          <div className={cx('product-details-info-price-info')}>
            <div className={cx('product-details-info-price-info-price')}>
                <bdo dir="rtl"><span className={cx('product-details-info-price-unit')}>
                حتى الآن
                </span>
      ...
      <div className={cx('bottom')}><bdo dir="rtl">{project.description}</bdo></div>
      <Drawer
        open={open}
        setOpen={setOpen}
        data={project}
